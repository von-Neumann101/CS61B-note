...
## BST
[[3. DataStructure and Algorithm/L16 Extends, Sets, Maps, and BSTs/L16 Extends, Sets, Maps, and BSTs|BSTs]]
用于**存储无重数据**
...
该数据结构的方法和[[3. DataStructure and Algorithm/L25.5 复习/L25.5 复习#BST|BST]]一致
...
## LLRBs（左倾红黑树）
[[3. DataStructure and Algorithm/L18 Red Black Trees/L18 Red Black Trees|LLRBs]]
...
## Hash Set（哈希表）
[[3. DataStructure and Algorithm/L19 Hashing I/L19 Hashing I|HashSet1]] & [[3. DataStructure and Algorithm/L20 Hashing II/L20 Hashing II|HashSet2]]
**用于存储数据**（无序）
...
注意hashCode和equals的对应关系——[[3. DataStructure and Algorithm/L20 Hashing II/L20 Hashing II#^ae4717|hashCode & equals]]
## Priority queue
